...
<template>
  ...
  >
    ...
    <div class="mt-5 flex justify-end gap-3">
      ...
      <button
        type="button"
        class="focus-ring rounded-md border-2 border-ink bg-danger hover:bg-danger-hover px-4 py-2 font-display text-sm tracking-tight text-on-primary shadow-(--shadow-hard) active:translate-y-1 active:translate-x-1 active:shadow-none"
        @click="emit('confirm')"
      >
        {{ confirmLabel }}
      </button>
